<footer x-data="{ open: false }" class="app-bottom-nav" aria-label="App navigation">
    <a href="/" wire:navigate.hover class="app-nav-item app-nav-active" aria-label="Home">
    ...
    <a href="{{ Auth::check() ? route('dashboard') : route('login') }}" wire:navigate.hover class="app-nav-item" aria-label="Profile">
